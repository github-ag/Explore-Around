...
day = string.capwords(input("Enter day : "))
if day != "Sunday":
    day = ""
fileName = "MetroFare" + day + ".csv"
toStation = string.capwords(input("Enter start station : "))
fromStation = string.capwords(input("Enter destination station : "))
